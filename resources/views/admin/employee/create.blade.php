<x-layout>
    <div class="bg-gray-200 min-h-screen pb-24">
        ...
        <div class="container mx-auto max-w-3xl mt-8">
            ...
            <h1 class="text-2xl font-bold text-gray-700 px-6 md:px-0">New Employee</h1>
                ...
                <div class="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
                    ...
                    <div class="md:w-2/3 w-full">
                        ...
                        <div class="px-16">
                            ...
                            <input type="text" value="{{ old('email') }}" name="email" class="mt-2 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500">
                            @error('email')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-16">
                            ...
                            <input type="date" value="{{ old('emp_start_date') }}" name="emp_start_date" class="mt-2 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500">
